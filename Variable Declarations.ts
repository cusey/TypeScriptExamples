...
/*
var declarations
In this above example, 'o' captured the variable 'l' declared in 'k'. At any point that 'o' gets called, the value of 'l' will be tied to the value of 'l' in 'k'. 
Even if 'o' is called once 'k' is done running, it will be able to access and modify 'l'.
*/
